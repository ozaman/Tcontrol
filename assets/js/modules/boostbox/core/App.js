...
// alert(this.getMenuState())
// alert(App.MENU_MINIMIZED)
if (this.getMenuState() == 1) {}
		if (this.getMenuState() === App.MENU_MINIMIZED) {
			...
			$('#img_mini').addClass('hide');
			$('#img_mini').removeClass('show');
		}
		else {
			$('#img_mini').removeClass('hide');
			$('#img_mini').addClass('show');
