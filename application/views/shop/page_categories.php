	...
	<div class="box box-outlined">
		...
		<div class="box-body table-responsive">
			<table class="table table-hover">
				<thead>
					<th bgcolor="#999999" height="25">ลัาดับ</th>
				...
				<tbody>
					...
					foreach($categorie as $key=>$val){
						...
						<tr>
							...
							<td>
								<button type="button" class="btn btn-xs btn-default btn-equal" onclick="get_categories_sub('<?=$val->id;?>')"><i class="fa fa-search-plus" ></i></button>
							</td>
							...
							<!-- <td></td> -->
							<td><span><?=$val->i_num_type;?></span></td>
							<td ><span><?=$val->i_num_type_open;?></span>
								
							</td>
							<td ><span><?=$val->i_num_type_close;?></span>
