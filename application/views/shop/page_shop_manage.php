    ...
    <div class="box box-outlined">
      <div class="box-head">
        <ul class="nav nav-tabs" data-toggle="tabs">
          <li class="" onclick="_box_region_show('<?=$_GET[id];?>','_company')"><a href="#shop_t_share"> T-share - ร้านค้า</a></li>
          <li class="active" onclick="_box_region_show('<?=$_GET[id];?>','')"><a href="#t_share_app"> T-share - Taxi</a></li>
          <li class="" onclick="_box_region_show('<?=$_GET[id];?>','_gui')"><a href="#t_share_guide"> T-share - Guide</a></li>
      ...
      <div class="box-body-s tab-content">
        <div class="tab-pane active" id="t_share_app">
          <div class="box-head" style="padding: 15px 0;">
            <div class="col-md-4">
              <h4 class="text-light">ประเภทรายจ่าย </h4>
            </div>
            <div class="col-md-4">
      ...
      // print_r(json_encode($arr[SHOPPING_CONTACT]));
          ...
          </div><!-- END T-share - Taxi -->




          <!-- T_SHARE - SHOPPING -->
          <div class="tab-pane" id="shop_t_share">
            <div class="box-head" style="padding: 15px 0;">
            <div class="col-md-4">
              <h4 class="text-light"> ประเภทรายจ่าย </h4>
            </div>
          ...
          <div class="tab-pane" id="t_share_guide">
            <div class="box-head" style="padding: 15px 0;">
            <div class="col-md-4">
              <h4 class="text-light"> ประเภทรายจ่าย </h4>
            </div>
...
<script>
  setTimeout(function(){
   cal_map('<?=$shop->id;?>')
   _box_region_show($('#manage_com').val(),'')
 }, 1000);
