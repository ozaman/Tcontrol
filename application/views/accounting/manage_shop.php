...
<div class="card">
  <form name="form_acc_trans_shop" id="form_acc_trans_shop"  enctype="multipart/form-data" class="form-horizontal form-bordered" role="form">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <table class="table">
                  <tr>
                    <td><span class="font-16">ธนาคาร</span></td>
                    <td>
                      <table>
                        <tr>
                          <td><img src="<?=base_url();?>assets/img/bank/<?=$data_bank->bank_img;?>" style="width:25px;" /></td>
                          <td width="5"></td>
        ...
        <div class="box box-outlined">
          ...
          <div class="box-body no-padding">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-7 col-md-8 col-sm-9">
                  <input type="file" name="slip_trans" id="uploadfile" name="uploadfile" onchange="readURLslip(this);" style="opacity: 1;">
                </div>
              </div>
              ...
              <div class="form-group">
                <table>
                  <tr>
                    ...
                    <td width="10"></td>
                    <td width="120"><input type="text" value="" class="form-control" name="hour"  autocomplete="off" placeholder="ex..13/07/2018"></td>
                    <td width="10"></td>
                    <td width="120"><input type="text" id="pay_transfer_time" value="" name="minute" class="form-control time-mask" placeholder="ex..16:54"></td>
                  </tr>
                </table>
              </div>
    ...
    <div style="margin: 5px;" align="center">
      <button type="button" class="btn" onclick="saveDataTransShop();">Save Data</button>
    </div> 
  </form>  
</div>